...
<body class="hm">
	<div>
		<form class="pb-5" action="<%=ORSView.ORDER_LIST_CTL%>" method="post">
			...
			&emsp;
				<div class="col-sm-2">
					<input type="text" name="orderName" placeholder="Enter Order Name"
						class="form-control"
				...
				&emsp;
				<div class="col-sm-3"><%=HTMLUtility.getList("Category", String.valueOf(dto.getCategory()), list1)%></div>
				...
				<table class="table table-bordered table-dark table-hover">
					<thead>
						<tr style="background-color: #8C8C8C;">
							...
							<th width="15%" class="text">OrderName</th>
					...
					<tbody>
						<tr>
							...
							<td class="text"><%=dto.getOrderName()%></td>
