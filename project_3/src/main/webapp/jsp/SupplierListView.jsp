...
<body class="hm">
	<div>
		<form class="pb-5" action="<%=ORSView.SUPPLIER_LIST_CTL%>"
			...
			%>
			<%
				List<SupplierDTO> list = (List<SupplierDTO>) request.getAttribute("proList");
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input type="number" class="form-control" name="payment" class="p1"
				...
				<table class="table table-bordered table-dark table-hover">
					<thead>
						<tr style="background-color: #8C8C8C;">
							...
							<th width="10%" class="text">Payment</th>
