...
<body class="hm">
	<div>
		<form class="pb-5" action="<%=ORSView.PROJECT_LIST_CTL%>"
			...
			<%
				List<ProjectDTO> list = (List<ProjectDTO>) request.getAttribute("proList");
				...
				<table class="table table-bordered table-dark table-hover">
					<thead>
						<tr style="background-color: #8C8C8C;">
							...
							<th width="15%" class="text">ProjectName</th>
							<th width="15%" class="text">TeamName</th>
							<th width="20%" class="text">SubmitDate</th>
							<th width="10%" class="text">ProjectNo</th>
					...
					<tbody>
						<tr>
							...
							<td class="text"><%=dto.getTeamName()%></td>
							<td class="text"><%=DataUtility.getDateString(dto.getSubmitDate())%></td>
							<td class="text"><%=dto.getProjectNo()%></td>
