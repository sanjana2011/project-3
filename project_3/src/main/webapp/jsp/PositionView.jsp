					...
					<div class="card">
						<div class="card-body">
							<%
								...
								if (dto.getId() != null) {
							%>
							<h3 class="text-center text-primary">Update Position</h3>
							<%
								} else {
							%>
							<h3 class="text-center text-primary">Add Position</h3>
							<%
								}
							%>
							<!--Body-->
							...
							<div class="md-form">
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" name="Designation" class="form-control"
											id="defaultForm-email" placeholder="Enter Designation"
								...
								<span class="pl-sm-5"><b>ReqExp</b><span
									style="color: red;">*</span></span> </br>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
										...
										<input type="text" name="ReqExp" class="form-control"
											placeholder="Enter ReqExp"
											value="<%=DataUtility.getStringData(dto.getReqExp())%>">
									</div>
								</div>
								<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("ReqExp", request)%></font></br>

								<span class="pl-sm-5"><b>Conditions</b><span
									style="color: red;">*</span></span> </br>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
										...
										<%
											...
											map.put("Colesd", "Colesd");
											map.put("open", "open");

											String htmlList = HTMLUtility.getList("Conditions", dto.getConditions(), map);
										%>
										<%=htmlList%></div>
										
								<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("Conditions", request)%></font></br>

								<span class="pl-sm-5"><b>OpeningDate</b> <span
									style="color: red;">*</span></span></br>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
