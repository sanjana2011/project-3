...
<%@page import="in.co.rays.project_3.controller.TransCtl"%>
...
<body class="p4">
	...
	<div>
		...
		<main>
		<form action="<%=ORSView.TRANS_CTL%>" method="post">
					...
					<div class="card">
						<div class="card-body">
							<%
								...
								if (dto.getId() != null) {
							%>
							<h3 class="text-center text-primary">Update Transport</h3>
							<%
								} else {
							%>
							<h3 class="text-center text-primary">Add Transport</h3>
							<%
								}
							%>
							<!--Body-->
							...
							<div class="md-form">
								...
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
											<div class="input-group-text">
												<i class="fa fa-money-check grey-text"
													style="font-size: 1rem;"></i>
											</div>
										</div>
										...
										<%
											...
											String htmlList = HTMLUtility.getList("Mode", dto.getMode(), map);
										%>
										<%=htmlList%></div>
								...
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
											<div class="input-group-text">
												<i class="fa fa-dollar-sign grey-text" style="font-size: 1rem;"></i>
											</div>
										</div>
										<input type="number" name="cost" class="form-control"
											placeholder="cost" maxlength="10"
							...
							<div class="text-center">
								...
								<input type="submit" name="operation"
									...
									value="<%=TransCtl.OP_UPDATE%>"> <input type="submit"
									name="operation" class="btn btn-warning btn-md"
									style="font-size: 17px" value="<%=TransCtl.OP_CANCEL%>">
							</div>
							<%
								} else {
							%>
							<div class="text-center">
								...
								<input type="submit" name="operation"
									class="btn btn-success btn-md" style="font-size: 17px"
									value="<%=TransCtl.OP_SAVE%>"> <input type="submit"
									name="operation" class="btn btn-warning btn-md"
									style="font-size: 17px" value="<%=TransCtl.OP_RESET%>">
							</div>
							<%
								}
							%>
